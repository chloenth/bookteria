...
public class PostService {
	...
	public PageResponse<PostResponse> getMyPosts(int page, int size) {
		...
		return PageResponse.<PostResponse>builder().currentPage(page).pageSize(pageData.getSize())
				.totalPages(pageData.getTotalPages()).totalElements(pageData.getTotalElements()).data(postList).build();
	}
}
